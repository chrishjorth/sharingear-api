...
updateRoadieWithID = function(userID, roadieID, updatedRoadieData, callback) {
    ...
    db.query("SELECT id, roadie_type, about, currently, genres, experience, xp_years, tours, companies, bands, price_a, price_b, price_c, address, postal_code, city, region, country, latitude, longitude, always_available, owner_id FROM roadies WHERE id=? LIMIT 1;", [roadieID], function(error, rows) {
        ...
        update = function(roadieTypeID, roadieTypeName) {
            ...
            roadieInfo = [
                roadieTypeID, (updatedRoadieData.about ? updatedRoadieData.about : rows[0].about), (updatedRoadieData.currently ? updatedRoadieData.currently : rows[0].currently), (updatedRoadieData.genres ? updatedRoadieData.genres : rows[0].genres), (updatedRoadieData.experience ? updatedRoadieData.experience : rows[0].experience), (updatedRoadieData.xp_years ? updatedRoadieData.xp_years : rows[0].xp_years), (updatedRoadieData.tours ? updatedRoadieData.tours : rows[0].tours), (updatedRoadieData.companies ? updatedRoadieData.companies : rows[0].companies), (updatedRoadieData.bands ? updatedRoadieData.bands : rows[0].bands), (updatedRoadieData.price_a ? updatedRoadieData.price_a : rows[0].price_a), (updatedRoadieData.price_b ? updatedRoadieData.price_b : rows[0].price_b), (updatedRoadieData.price_c ? updatedRoadieData.price_c : rows[0].price_c), (updatedRoadieData.currency ? updatedRoadieData.currency : rows[0].currency), (updatedRoadieData.address ? updatedRoadieData.address : rows[0].address), (updatedRoadieData.postal_code ? updatedRoadieData.postal_code : rows[0].postal_code), (updatedRoadieData.city ? updatedRoadieData.city : rows[0].city), (updatedRoadieData.region ? updatedRoadieData.region : rows[0].region), (updatedRoadieData.country ? updatedRoadieData.country : rows[0].country), (updatedRoadieData.latitude ? updatedRoadieData.latitude : rows[0].latitude), (updatedRoadieData.longitude ? updatedRoadieData.longitude : rows[0].longitude),
                roadieID
            ];
